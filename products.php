...
include('header.php'); // Assuming this includes your header and a function to connect to the DB
...
<style>
    ...
    /* Zepto-style View Cart Button */
    .bottom-nav-cart {
        position: fixed;
        left: 50%;
        bottom: 85px; /* Adjust based on your bottom nav height */
    ...
    .snackbar.err { background: #7f1d1d; border-color: #ef4444; }.notification-badge {
    position: absolute;
    top: 1px;
    right: 32px;
...
<nav class="bottom-nav">
    <button class="active" onclick="location.href='products.php'"><i class="fa-solid fa-house"></i><span>Home</span></button>
    <button onclick="location.href='orders.php'"><i class="fa-solid fa-bag-shopping"></i><span>Orders</span></button>
    <button onclick="location.href='profile.php'"><i class="fa-solid fa-user"></i><span>Profile</span></button>  <button id="bellButton"><i class="fa-solid fa-bell"></i><span>Nodification</span><span class="notification-badge" id="unreadCountBadge">0</span></button>
</nav>
</nav>
