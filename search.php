...
if ($con && !empty($searchQuery)) {
    // Use a prepared statement to prevent SQL injection
    $stmt = $con->prepare("SELECT id, product_name, product_image, original_price, selling_price FROM product WHERE product_name LIKE ?");
...
<style>
    ...
    .bottom-nav-cart {
        position: fixed;
        left: 50%;
        bottom: 70px; /* Adjust based on your bottom nav height */
...
<div class="section-head">
   <h5 class="mb-4">Search Results for "<?= h($searchQuery) ?>"</h5>
</div>
